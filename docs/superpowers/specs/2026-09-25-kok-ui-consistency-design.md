...
Sebagai menu utama, judul halaman cukup "Atlet" tanpa tombol kembali. Pencarian nama atau kode tetap di atas daftar. Tombol "Filter" membuka bottom sheet berisi jenis kelamin dan status, dengan aksi "Reset" dan "Terapkan" serta penanda saat filter aktif. Pilihan di sheet ditahan sementara; "Terapkan" memperbarui kedua filter bersama-sama, sedangkan "Reset" mengosongkan pilihan di sheet sebelum diterapkan. Ini menggantikan deretan chip panjang pada layar sempit tanpa mengubah pilihan filter. Kartu menampilkan foto, nama yang boleh dua baris, cabor, informasi klub atau keterangan belum tercatat, kode, dan status dengan ukuran teks terbaca.
