...
|:---|:---|:---:|:---|
| **Login** | [login_page.dart](../../../lib/features/login_page.dart) | AuthController | 4 demo accounts (perlu conditional) |
| **Dashboard** | [home_page.dart](../../../lib/features/home_page.dart) | snapshotProvider ✅ | Fallback text minor |
| **Cabor** | [sports_page.dart](../../../lib/features/sports_page.dart) | snapshotProvider ✅ | — |
| **Sport Detail** | [sport_detail_page.dart](../../../lib/features/sport_detail/sport_detail_page.dart) | snapshotProvider ✅ | — |
| **Klub** | [clubs_page.dart](../../../lib/features/clubs_page.dart) | snapshotProvider ✅ | — |
| **Club Detail** | [club_detail_page.dart](../../../lib/features/club_detail/club_detail_page.dart) | snapshotProvider ✅ | — |
| **Club Dokumen** | [club_document_tab.dart](../../../lib/features/club_detail/club_document_tab.dart) | snapshotProvider | Kategori dokumen hardcoded |
| **Profil Atlet** | [athlete_detail_page.dart](../../../lib/features/athlete_detail/athlete_detail_page.dart) | snapshotProvider | ⚠️ Riwayat, telepon, alamat hardcoded |
| **Anggota** | [committee_page.dart](../../../lib/features/committee_page.dart) | snapshotProvider ✅ | — |
| **Profil** | [profile_page.dart](../../../lib/features/profile_page.dart) | snapshotProvider + user | ⚠️ Helpdesk contacts hardcoded |
| **Perhatian** | [attention_page.dart](../../../lib/features/attention_page.dart) | snapshotProvider ✅ | — |
| **Pencarian** | [global_search_page.dart](../../../lib/features/search/global_search_page.dart) | snapshotProvider ✅ | — |
...
#### [MODIFY] [models.dart](../../../lib/data/models.dart)
...
#### [MODIFY] [demo_kok_repository.dart](../../../lib/data/demo_kok_repository.dart)
...
#### [MODIFY] [kok_repository.dart](../../../lib/data/kok_repository.dart)
...
#### [NEW] [providers/club_providers.dart](../../../lib/data/providers/club_providers.dart)
...
#### [NEW] [core/network/api_client.dart](../../../lib/core/network/api_client.dart)
...
#### [MODIFY] [core/config/deployment_profile.dart](../../../lib/core/config/deployment_profile.dart)
...
#### [MODIFY] [core/auth/presentation/auth_controller.dart](../../../lib/core/auth/presentation/auth_controller.dart)
...
#### [NEW] [core/auth/data/remote_auth_repository.dart](../../../lib/core/auth/data/remote_auth_repository.dart)

Placeholder implementasi `AuthRepository` dengan Dio (stub yang throw `UnimplementedError` sampai endpoint tersedia).

#### [NEW] [data/remote_kok_repository.dart](../../../lib/data/remote_kok_repository.dart)
...
#### [MODIFY] [features/login_page.dart](../../../lib/features/login_page.dart)

Conditional demo accounts: hanya tampil jika `profile.authMode == AuthMode.demo`.

#### [MODIFY] [features/athlete_detail/athlete_detail_page.dart](../../../lib/features/athlete_detail/athlete_detail_page.dart)
...
#### [MODIFY] [features/club_detail/club_document_tab.dart](../../../lib/features/club_detail/club_document_tab.dart)

Dokumen → ambil dari `club.documents` (bukan hardcoded 'SK Klub', 'Kepengurusan').

#### [MODIFY] [features/profile_page.dart](../../../lib/features/profile_page.dart)

Helpdesk kontak → ambil dari `snapshot.helpdesk` (bukan hardcoded demo contacts).

#### [MODIFY] [core/auth/domain/user_principal.dart](../../../lib/core/auth/domain/user_principal.dart)
...
#### [NEW] [core/network/api_exceptions.dart](../../../lib/core/network/api_exceptions.dart)
