...
- Pada implementasi sebelumnya di [`lib/features/club_detail/club_detail_page.dart`](../../../lib/features/club_detail/club_detail_page.dart):
  - `SliverAppBar` menggunakan `expandedHeight: 500`.
  - Pada [`lib/features/club_detail/club_detail_header.dart`](../../../lib/features/club_detail/club_detail_header.dart), konten dibungkus dengan `padding: const EdgeInsets.fromLTRB(24, 0, 24, 100)`.
...
- **Keputusan Desain**:
  ...
  - Pada acuan desain Figma ([`detail-klub-binamuda-atlet.png`](../../../ui-screenshot-figma/detail-klub-binamuda-atlet.png)), jarak antara baris statistik dan kartu putih adalah **~24px – 28px**.
...
- Pada header Beranda ([`DashboardHeaderDecoration`](../../../lib/features/dashboard_decorations.dart)), terdapat aksen garis lengkung dan matriks titik putih yang memberikan nuansa modern, elegan, dan dinamis.
