...
- Sesuai dengan spesifikasi [docs/archive/specs/2026-09-08-auth-and-session-architecture-design.md](../specs/2026-09-08-auth-and-session-architecture-design.md) dan audit [docs/audit-auth.md](../audits/auth/audit-auth.md).
...
Create `test/session_scope_test.dart` (termasuk tes regresi audit [docs/audit-auth.md: Baris 1010-1036](../audits/auth/audit-auth.md)):
```dart
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:kok_app/core/auth/data/demo_auth_repository.dart';
