...
**Spec:** `docs/archive/audits/auth/audit-auth-review-tahap1-ketiga.md` dan `docs/archive/specs/2026-09-10-auth-hardening-patch-3-design.md`.
...
- Modify: `README.md`
- Create: `docs/archive/audits/auth/acceptance-manifest-patch-3.1.md`
- Create: `docs/archive/audits/auth/evidence/patch-3.1-verification.md`
