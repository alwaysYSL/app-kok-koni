...
final class SicaborClubDetailItem {
  ...
  factory SicaborClubDetailItem.fromJson(Map<String, dynamic> json) {
    return SicaborClubDetailItem(
      ...
      training: _asNullableMap(json['training']),
      fileSk: json['file_sk']?.toString(),
      officials: _asMap(json['officials']),
      coaches: _asMap(json['coaches']),
      management: _asMap(json['management']),
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is SicaborClubDetailItem &&
          ...
          mapEquals(training, other.training) &&
          fileSk == other.fileSk &&
          mapEquals(officials, other.officials) &&
          mapEquals(coaches, other.coaches) &&
          mapEquals(management, other.management);
  ...
  int get hashCode => Object.hashAll([
    ...
    totalAthleteInClub,
    training != null ? _mapHashCode(training!) : null,
    fileSk,
    _mapHashCode(officials),
    _mapHashCode(coaches),
    _mapHashCode(management),
  ]);
}
