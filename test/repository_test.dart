...
void main() {
  ...
  test('filterClubs with ClubSortOption supports all 4 sort options', () async {
    ...
    // 2. nameDesc
    final nameDesc = filterClubs(data.clubs, sortOption: ClubSortOption.nameDesc);
    expect(
      nameDesc.map((c) => c.name).toList(),
      [
        'Voli Bina Muda',
        'Tirta Kencana',
        'Silat Panglipur',
    ...
    expect(
      athletesDescSnapshot.map((c) => c.id).toList(),
      ['silat', 'garuda', 'pb', 'voli', 'tirta'],
    );
    ...
    expect(
      athletesDescPeople.map((c) => c.id).toList(),
      ['silat', 'garuda', 'pb', 'voli', 'tirta'],
    );
    ...
    expect(
      statusActiveFirst.map((c) => c.id).toList(),
      ['garuda', 'pb', 'silat', 'voli', 'tirta'],
    );
    ...
    const dummyClubs = [
      Club(id: 'c1', name: 'Z Inactive', sport: 'Sport', village: 'V', active: false),
      Club(id: 'c2', name: 'A Inactive', sport: 'Sport', village: 'V', active: false),
      Club(id: 'c3', name: 'Z Active', sport: 'Sport', village: 'V', active: true),
      Club(id: 'c4', name: 'A Active', sport: 'Sport', village: 'V', active: true),
    ];
    ...
    const dummyPeople = [
      SportPerson(id: 'p1', name: 'P1', clubId: 'c1', role: 'Atlet', group: 'G'),
      SportPerson(id: 'p2', name: 'P2', clubId: 'c2', role: 'Pelatih', group: 'G'),
    ];
